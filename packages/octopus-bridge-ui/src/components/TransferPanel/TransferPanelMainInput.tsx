  ...
  (props: React.InputHTMLAttributes<HTMLInputElement>) => {
    return (
      <input
        ...
        className="h-full w-full bg-transparent px-3 text-xl font-light text-white placeholder:text-gray-300 sm:text-2xl"
        {...props}
      />
    )
  }
      ...
      <>
        <div className={twMerge('flex flex-row rounded bg-black/40 shadow-2')}>
          ...
          >
            ...
            />
            <div className="flex flex-col items-end pb-2 pt-1">
